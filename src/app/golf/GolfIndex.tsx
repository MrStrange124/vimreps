...
export function GolfIndex() {
  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-5 py-9">
      <h1 className="font-sans text-[1.75rem] font-semibold text-white">Golf</h1>
            ...
            <li key={challenge.slug}>
              ...
              >
                <div className="min-w-0">
                  <div className="font-sans text-[0.9375rem] font-semibold text-ink">
                    {challenge.title}
                  </div>
                  <div className="truncate text-[0.78125rem] text-muted">{challenge.blurb}</div>
                </div>

                <div className="ml-auto shrink-0 text-right text-[0.75rem]">
